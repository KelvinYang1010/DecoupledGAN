...
parser.add_argument("--z", help="path to z(pose) source image", default='pose/pose-1.png')
parser.add_argument("--b", help="path to b(background) source image", default='background/background-1.png')
parser.add_argument("--p", help="path to p(shape) source image", default='shape/shape-1.png')
parser.add_argument("--c", help="path to c(texture) source image", default='color/color-1.png')
parser.add_argument("--out", help="path to output image", default='../output/code-1.png')
parser.add_argument("--mode", help="either code or feature", default='code')
parser.add_argument("--models", help="dir to pretrained models", default='../models')
